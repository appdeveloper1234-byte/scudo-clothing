...
const shopMainImage = (slug) => `/shop-all-main/${slug}.webp`
...
export const products = [
  ...
  },
  {
    ...
    images: catalogImages('brazil-home', 7), shopImage: shopMainImage('brazil-home'), isNew: false, isFeatured: true
  },
  {
    ...jerseyDefaults,
    ...
    images: catalogImages('brazil-blue-away', 7), shopImage: shopMainImage('brazil-blue-away'), isNew: false, isFeatured: false
  },
  {
    ...jerseyDefaults,
    ...
    images: catalogImages('barcelona-player-home', 6), shopImage: shopMainImage('barcelona-player-home'), material: 'Engineered performance mesh', isNew: true, isFeatured: false
  },
  {
    ...jerseyDefaults,
    ...
    images: catalogImages('france-away', 5), shopImage: shopMainImage('france-away'), isNew: true, isFeatured: false
  },
  {
    ...jerseyDefaults,
    ...
    price: 2499, salePrice: 1199, sku: 'SC-FRA-H06', colors: ['Blue', 'White'], inventory: 20,
    images: catalogImages('france-home', 7), shopImage: shopMainImage('france-home'), isNew: false, isFeatured: true
  },
  {
    ...jerseyDefaults,
    ...
    images: catalogImages('portugal-away', 5), shopImage: shopMainImage('portugal-away'), material: 'Ultra-light performance mesh', isNew: false, isFeatured: true
  },
  {
    ...jerseyDefaults,
    ...
    images: catalogImages('portugal-black-special', 6), shopImage: shopMainImage('portugal-black-special'), material: 'Jacquard performance polyester', isNew: false, isFeatured: true
  },
  {
    ...jerseyDefaults,
    ...
    images: catalogImages('portugal-home-kit', 6), shopImage: shopMainImage('portugal-home-kit'), isNew: false, isFeatured: false
  },
  {
    ...jerseyDefaults,
    ...
    images: catalogImages('real-madrid-home', 5), shopImage: shopMainImage('real-madrid-home'), material: 'Authentic performance knit', isNew: false, isFeatured: false
  },
  {
    ...jerseyDefaults,
